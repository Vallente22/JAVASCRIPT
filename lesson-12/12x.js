...
function autoPlay() {
  const text = document.querySelector('.js-auto-play-button');
  if (!isAutoPlaying) {
...
function resetConfirmation() {
  document.querySelector('.js-confirmation')
    .innerHTML = `Are you sure you want to reset the score? <button class="js-confirm-yes-button confirm-yes-button">Yes</button> <button class="js-confirm-no-button confirm-no-button">No</button>`;
